<div class="modal fade" id="postModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ url('/user/post/update') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                {{--class="form-control">--}}
                                <select name="state" id="post-state" class="col-lg-6 form-control">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select name="reviewer" id="post-reviewer" class="col-lg-6 form-control">
                                </select>
